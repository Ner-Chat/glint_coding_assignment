...
When clicking the X button to delete a row, a confirmation dialog should appear asking "Are you sure you want to delete this row?" Build a custom modal component using Tailwind CSS (do not use `window.confirm` or `window.alert`).
...
**Guidelines:**
- Use pure Tailwind CSS for styling (no additional CSS frameworks or UI libraries)
- Modify existing components rather than creating an entirely new file structure
- You may add a few child components if needed, but keep the overall architecture intact
- Focus on styling and UX improvements, not adding new features or services
...
- Ability to work within existing code constraints
